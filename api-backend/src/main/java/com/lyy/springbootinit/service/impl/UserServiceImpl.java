...
import static com.lyy.apicommon.constant.RabbitmqConstant.EXCHANGE_SMS_INFORM;
import static com.lyy.apicommon.constant.RabbitmqConstant.ROUTINGKEY_SMS;
import static com.lyy.apicommon.constant.RedisConstant.LOGINCODEPRE;
...
import com.lyy.apicommon.common.JwtUtils;
import com.lyy.apicommon.entity.SmsMessage;
...
import com.lyy.springbootinit.model.vo.UserDevKeyVO;
import com.lyy.springbootinit.model.vo.UserVO;
import com.lyy.springbootinit.utils.FileUploadUtil;
import com.lyy.springbootinit.utils.LeakyBucket;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "Lian";
...
//        }
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        String userJson = stringRedisTemplate.opsForValue().get(UserConstant.USER_LOGIN_STATE + userId);
    ...
    public boolean userLogout(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Cookie cookie : cookies) {
            if (cookie.getName().equals("token")) {
                Long userId = JwtUtils.getUserIdByToken(request);
                stringRedisTemplate.delete(UserConstant.USER_LOGIN_STATE + userId);
