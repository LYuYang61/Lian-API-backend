package com.lyy.apithirdpartyservices.controller;
...
import com.lyy.apithirdpartyservices.config.AliPayConfig;
import com.lyy.apithirdpartyservices.model.dto.AlipayRequest;
import com.lyy.apithirdpartyservices.model.entity.AlipayInfo;
import com.lyy.apithirdpartyservices.service.AlipayInfoService;
import com.lyy.apithirdpartyservices.utils.OrderPaySuccessMqUtils;
...
import static com.lyy.apicommon.constant.RedisConstant.*;
...
public class AliPayController {
    ...
    public BaseResponse<String> payCode(@RequestBody AlipayRequest alipayRequest) throws AlipayApiException {
        ...
        request.setNotifyUrl("http://www.Lian-code.work:9000/api/third/alipay/notify");
